...
public class HandlingAccordian {
    ...
    public static void main(String[] args) {
        ...
        List<WebElement> availableUnitsTitles = driver.findElements(By.cssSelector("div.relative div.hidden.md\\:block div[class*='grid units-grid']"));
        ...
        for (int i = 0; i < availableUnitsTitles.size(); i++) {
            ...
            if (availableUnitsTitle.getText().equalsIgnoreCase("unit ID")) {
                ...
                WebElement availableUnit = driver.findElement(By.cssSelector("div.grid.group.units-grid > div.font-secondary.text-s:nth-child(" + (i + 1) + ")"));
